...
XDate.locales['hr'] = {
    monthNames: ["Sijecanj","Veljaca","Ožujak","Travanj","Svibanj","Lipanj","Srpanj","Kolovoz","Rujan","Listopad","Studeni","Prosinac"],
...
XDate.locales['cs'] = {
  monthNames: ["ledna","února","brezna","dubna","kvetna","cervna","cervence","srpna","zárí","ríjna","listopadu","prosince"],
  monthNamesShort: ["Led","Úno","Bre","Dub","Kve","Cer","Cerv","Srp","Zár","Ríj","Lis","Pro"],
